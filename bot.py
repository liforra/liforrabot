...
class Bot:
    ...
    async def on_message(self, message):
        ...
        is_mention = self.client.user in message.mentions or (message.reference and message.reference.resolved and message.reference.resolved.author == self.client.user)
        contains_name = "luma" in message.content.lower()

        if (is_ai_channel and not message.content.startswith(tuple(self.command_prefix))) or is_mention or contains_name:
